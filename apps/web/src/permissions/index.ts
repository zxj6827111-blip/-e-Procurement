...
export const phase2RouteAllowlist = [
  ...
  "/api/announcements/:announcementId/close",
...
export const phase4RouteAllowlist = [
  ...
  "/api/scoring-templates/:templateId",
  "/api/scoring-templates/:templateId/clone",
  "/api/scoring-templates/:templateId/enable",
...
export const hotelClosedLoopRouteAllowlist = [
  ...
  "/api/bpmn/definitions/:definitionId",
  "/api/bpmn/definitions/validate",
  "/api/bpmn/definitions/:definitionId/enable",
  "/api/bpmn/definitions/:definitionId/disable",
  "/api/bpmn/change-logs",
  "/api/bpmn/simulate",
  "/api/bpmn/pilots",
  "/api/bpmn/pilots/:pilotId/enable",
  "/api/bpmn/pilots/:pilotId/disable",
  "/api/bpmn/pilots/:pilotId/scope",
  "/api/bpmn/pilots/:pilotId/switch-definition",
  "/api/bpmn/pilots/:pilotId/rollback",
  "/api/bpmn/pilot-health",
  "/api/bpmn/pilot-runs",
  "/api/bpmn/pilot-change-logs"
];
