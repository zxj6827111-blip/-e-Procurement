...
const navCatalog: Record<string, NavItem> = {
  ...
  expertDirectory: { id: "expertDirectory", label: "专家库管理", to: "/expert-directory", menuKey: "expertReview", description: "专家档案与账号" },
...
export const roleProfiles: Record<RoleId, RoleProfile> = {
  group_manager: {
    ...
    home: "/",
    template: "A",
    sidebar: ["myTasks", "approvalRules", "demandApproval", "projectWorkbench", "bidControl", "expertDirectory", "expertReview", "scoringTemplates", "awardApproval", "supplierList", "supplyMall", "financeSettlement", "paymentStatus", "archiveAudit"],
  ...
  buyer: {
    ...
    home: "/",
    template: "A",
    sidebar: ["myTasks", "procurementRequests", "projectWorkbench", "supplyMall", "expertReview", "awardApproval", "orderFulfillment", "settlementMaterials", "paymentStatus", "archiveAudit"],
    showMessageBell: true
  },
  platform_operator: {
    label: "平台运营",
    home: "/",
    template: "A",
    sidebar: ["myTasks", "procurementRequests", "projectWorkbench", "supplyMall", "expertReview", "scoringTemplates", "awardApproval", "orderFulfillment", "settlementMaterials", "paymentStatus", "archiveAudit"],
    showMessageBell: true
  },
  hotel_buyer: {
    label: "酒店采购",
    home: "/",
    template: "B",
    sidebar: ["dashboard", "myTasks", "procurementRequests", "supplyMall", "orderFulfillment", "settlementMaterials", "paymentStatus"],
    showMessageBell: true
  },
  hotel_finance: {
    label: "酒店财务",
...
const routeAccessRules: Array<{ test: (path: string) => boolean; roles: RoleId[]; mockOnly?: boolean }> = [
  ...
  { test: (path) => path === "/expert-directory", roles: ["group_manager"] },
  ...
  { test: (path) => path === "/account-security", roles: [...businessRoles, "admin"] },
  ...
  { test: (path) => /^\/project-workbench\/[^/]+\/fulfillment$/.test(path), roles: ["group_manager", "buyer", "platform_operator", "auditor", "supplier", "supplier_admin", "supplier_quotation"] },
  ...
  { test: (path) => path === "/settlement-materials", roles: ["group_manager", "buyer", "hotel_buyer", "platform_operator", "supplier", "supplier_admin", "supplier_quotation", "hotel_finance", "finance_reviewer"] },
  { test: (path) => path === "/payment-status", roles: ["group_manager", "buyer", "hotel_buyer", "platform_operator", "hotel_finance", "finance_reviewer"] },
