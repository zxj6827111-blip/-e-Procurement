        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left">
            ...
            <tbody className="divide-y divide-slate-100">
              {BUSINESS_CASES.map(project => (
                <tr key={project.id} className="hover:bg-slate-50/50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="font-medium text-slate-900">{project.name}</div>
                    <div className="text-slate-500 text-xs mt-1 font-mono">{project.code}</div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="text-slate-900">{project.organization}</div>
                    <div className="text-slate-500 text-xs mt-1">{project.agent}</div>
                  </td>
                  <td className="px-6 py-4">
