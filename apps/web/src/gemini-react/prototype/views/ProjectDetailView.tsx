...
import { BUSINESS_CASES } from '../data';
import { Card, CardContent, CardHeader, CardTitle } from '../components/ui/Card';
import { Badge } from '../components/ui/Badge';
import { Button } from '../components/ui/Button';
import { StageNames, type Project, type ProjectStage } from '../types';
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div>
            ...
            <div className="flex items-center gap-4 text-sm text-slate-500 font-medium">
              <span className="font-mono bg-slate-100 px-2 py-0.5 rounded">{project.code}</span>
              <span>组织: {project.organization}</span>
              <span>经办: {project.agent}</span>
              <span>方式: {project.method}</span>
            </div>
          </div>
