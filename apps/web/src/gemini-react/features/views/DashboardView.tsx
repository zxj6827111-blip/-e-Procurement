...
export function DashboardView() {
  ...
  const dashboardView = DashboardContract.toDashboardViewModel({
    todoCount: todos.length,
    quoteDeadlineCount: 2,
    reviewCount: 4,
    exceptionCount: todos.filter((todo) => todo.type === 'EXCEPTION').length,
    updatedAtLabel: '2026-07-05 14:00'
  }).viewModel;
          ...
          <CardContent className="p-5">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-3xl font-bold text-slate-900">{dashboardView.todoCount}<span className="text-sm font-normal text-slate-500 ml-1">项</span></p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-3xl font-bold text-slate-900">{dashboardView.quoteDeadlineCount}<span className="text-sm font-normal text-slate-500 ml-1">个</span></p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-3xl font-bold text-slate-900">{dashboardView.reviewCount}<span className="text-sm font-normal text-slate-500 ml-1">个</span></p>
              </div>
          ...
          <CardContent className="p-5">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-3xl font-bold text-rose-600">{dashboardView.exceptionCount}<span className="text-sm font-normal text-rose-600/70 ml-1">起</span></p>
              </div>
