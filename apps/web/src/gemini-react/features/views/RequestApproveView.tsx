...
import { ProcurementContract } from '../../../contracts';
...
export function RequestApproveView() {
  ...
  const requests = [
    { id: 'REQ-2026-001', hotel: '北京朝阳大酒店', dept: '客房部', budgetAmount: 150000, category: '客房易耗品', status: '待审批', date: '2026-07-05', method: '公开招标' },
    { id: 'REQ-2026-002', hotel: '上海浦东分店', dept: '工程部', budgetAmount: 800000, category: '电梯维保', status: '待审批', date: '2026-07-04', method: '邀请招标' },
    { id: 'REQ-2026-003', hotel: '广州天河店', dept: '餐饮部', budgetAmount: 35000, category: '后厨生鲜', status: '待审批', date: '2026-07-05', method: '竞争性比选' }
  ].map((request) => ({
    ...request,
    contract: ProcurementContract.toRequestViewModel({
      id: request.id,
      title: request.category,
      procurementMethod: request.method,
      budgetAmount: request.budgetAmount,
      approvalOpinion: '待采购中心审核',
      supplierRiskLevel: '待复核',
      quotationVersion: 'V1',
      archiveStatus: '待归档',
                ...
                {requests.map(r => {
                  ...
                  return (
                    <tr key={r.id} className="hover:bg-slate-50/50">
                      ...
                      <td className="px-6 py-4">
                        <div>{r.category}</div>
                        <div className="text-[#006666] font-medium">{r.contract.budgetAmount.display}</div>
                      </td>
                      <td className="px-6 py-4">
