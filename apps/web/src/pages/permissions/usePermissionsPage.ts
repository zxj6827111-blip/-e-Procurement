...
export function usePermissionsPage() {
  ...
  const summaryItems = computed(() => [
    ...
    { label: "规则试点", value: bpmnHealthSummary.value.pilotCount, meta: "灰度管理" },
    { label: "兼容率", value: bpmnHealthSummary.value.compatibleRate === null ? "-" : `${Math.round(bpmnHealthSummary.value.compatibleRate * 100)}%`, meta: "试点观察" },
