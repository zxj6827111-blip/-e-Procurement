...
| 无权限页 | 1440x900 | PASS | docs/sellable-readiness/visual-review-pack/permission-denied-1440x900.png | 313 | shell=1 | 0 |
| 错误状态 | 1440x900 | PASS | docs/sellable-readiness/visual-review-pack/error-state-1440x900.png | 306 | shell=1 | 0 |
| 空状态 | 1440x900 | PASS | docs/sellable-readiness/visual-review-pack/empty-state-1440x900.png | 3880 | shell=1 | 1 |
